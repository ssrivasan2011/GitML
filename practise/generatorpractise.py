...
class generatorexample(object):
    ...
    def dataGeneration(self):
        genList=['ttms,chi,crc']
        ttms=['10.10.11.10','10.11.10.11','10.10.10.10','11.10.11.11']
        logger.info('The time taken for the response is {}'.format(self))
        chi=['11.11.11.11','10.12.13.10','11.10.10.12','13.11.14.17']
        logger.info('The IP address of the client host is {}'.format(self))
        crc=['10.10.10.11','10.10.13.10','10.10.10.10','10.11.12.11']
        logger.info('hit/miss {}'.format(self))
        '''
